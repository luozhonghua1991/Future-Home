...
- (void)upBtnClick {
    if (_delegate != nil && [_delegate respondsToSelector:@selector(artileOrVideoShareLikeClickWithModel:withBtn:)]) {
        [_delegate artileOrVideoShareLikeClickWithModel:self.model withBtn:self.upBtn];
    }
}
