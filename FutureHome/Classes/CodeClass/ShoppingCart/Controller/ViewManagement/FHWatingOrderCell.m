...
- (void)setOrderModel:(FHOrderListModel *)orderModel {
    ...
    [self.shopImgView sd_setImageWithURL:[NSURL URLWithString:_orderModel.cover] placeholderImage:nil];
...
- (void)setGoodsModel:(GNRGoodsModel *)goodsModel {
    ...
    [self.shopImgView sd_setImageWithURL:[NSURL URLWithString:_goodsModel.goodsImage] placeholderImage:nil];
