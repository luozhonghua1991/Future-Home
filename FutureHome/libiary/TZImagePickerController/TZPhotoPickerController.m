...
//            [imagePickerVc showAlertWithTitle:[NSBundle tz_localizedStringForKey:@"Can not choose both video and photo"]];
            ...
            CustomAlertView *customAlertView = [[CustomAlertView alloc] initWithTitle:nil message:[NSBundle tz_localizedStringForKey:@"Can not choose both video and photo"] buttonColor:@[COLOR_25] buttonTitles:@"我知道了", nil];
            [customAlertView showWithCompletion:^(NSInteger selectIndex) {
