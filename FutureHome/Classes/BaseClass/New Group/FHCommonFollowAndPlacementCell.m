...
- (void)layoutSubviews {
    ...
    self.nameLabel.frame = CGRectMake(MaxX(self.headerImgView) + 10, 30, 200, 13);
    self.fnansLabel.frame = CGRectMake(MaxX(self.headerImgView) + 10, MaxY(self.nameLabel) + 15, 200, 13);
    self.rightBtn.frame = CGRectMake(self.contentView.width - 60, MaxY(self.nameLabel), 40, 25);
}
