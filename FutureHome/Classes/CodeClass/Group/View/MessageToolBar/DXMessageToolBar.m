...
- (void)setupSubviews
{
    ...
    [self.styleChangeButton setImage:[UIImage imageNamed:@"yuyin"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"jianpan"] forState:UIControlStateSelected];
...
//
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"jiahao"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"jiahao"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"jianpan"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"naozhong"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"naozhong"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"naozhong_lan"] forState:UIControlStateSelected];
    ...
    // 初始化输入框
    if (self.type==MessageTypeGroupChat) {
     self.inputTextView = [[XHMessageTextView  alloc] initWithFrame:CGRectMake(textViewLeftMargin, kVerticalPadding, width +40, kInputTextViewMinHeight)];
    ...
    self.recordButton.titleLabel.font = FontNeveLightWithSize(16);
    [self.recordButton setTitleColor:RGB(87, 87, 87) forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"yuyinbg"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[[UIImage imageNamed:@"yuyinbg"] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
...
//    if (!self.faceView) {
//        DXFaceView*faceView = [[DXFaceView alloc] initWithFrame:CGRectMake(0, (kVerticalPadding * 2 + kInputTextViewMinHeight), self.frame.size.width, 200)];
...
//    }
    ...
    if (!self.recordView) {
        self.recordView = [[DXRecordView alloc] initWithFrame:CGRectMake(90, 130, 150, 150)];
    }
...
//    if ([self.delegate respondsToSelector:@selector(aClockButtonClick )]) {
//        [self.delegate aClockButtonClick];
//    }
}
