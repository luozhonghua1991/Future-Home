...
- (FHCollectionHeaderView *)headerView {
    if (!_headerView) {
        ...
        _headerView.leftNameArrs = @[@"总车位数",@"车位管理费",@"商铺物业费",@"其他费用",@"总车位数",@"车位管理费",@"商铺物业费",@"其他费用",@"总车位数",@"车位管理费",@"商铺物业费",@"其他费用"];
        _headerView.rightNameArrs = @[@"555",@"免费",@"22",@"10元",@"33",@"10元",@"2147483647",@"10+1元/小时",@"55",@"免费",@"66",@"2元/次"];
    }
    return _headerView;
}
