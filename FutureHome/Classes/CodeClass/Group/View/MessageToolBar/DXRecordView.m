...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        bgView.backgroundColor = RGB(1, 1, 1);
        bgView.alpha = 0.5;
        ...
        _recordAnimationView.image = [UIImage imageNamed:@"0"];
        ...
        _textLabel.text = @"手指上滑取消录音";
        
        [self addSubview:_textLabel];
        _textLabel.font = FontNeveLightWithSize(16);
        _textLabel.textColor = RGB(235, 235, 235);
