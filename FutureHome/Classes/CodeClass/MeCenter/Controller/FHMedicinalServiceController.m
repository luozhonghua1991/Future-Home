//
//  FHMedicinalServiceController.m
//  FutureHome
//
...
@interface FHMedicinalServiceController () <UITextFieldDelegate,UIScrollViewDelegate,FHCertificationImgViewDelegate,FHUserAgreementViewDelegate>
/** 大的滚动视图 */
...
@implementation FHMedicinalServiceController
...
- (FHAccountApplicationTFView *)accountTypeView {
    if (!_accountTypeView) {
        ...
        _accountTypeView.contentTF.text = @"医药药品服务平台账号";
...
- (FHAccountApplicationTFView *)serviceDeskView {
    if (!_serviceDeskView) {
        ...
        _serviceDeskView.titleLabel.text = @"医药药品服务平台名称";
