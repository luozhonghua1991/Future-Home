...
@interface FHAddressPickerView () <UIPickerViewDelegate, UIPickerViewDataSource>
//取消按钮
...
/** 区的code */
@property (nonatomic, copy) NSString *parentAdcodeString;


@end

@implementation FHAddressPickerView
...
- (void)makeUI {
    ...
    if (_addressPickerViewModel == kAddressPickerViewModelAll) {
        ...
        _parentAdcodeString = [_districtMutableArray.firstObject valueForKey:@"parentAdcode"];
