...
-(void)show
{
    _adImageView.frame = CGRectMake(0, 0, CGRectGetWidth(SDScreenBounds), CGRectGetHeight(SDScreenBounds)/_aspectRadio);
...
-(void)onTimer:(NSTimer*)timer
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [weakSelf.skipButton setTitle:title forState:UIControlStateNormal];
    });
