...
//    if ([self.wolfKill isEqualToString:@"wolfKill"]) {
//        attriStr = [CWCViewController willChangeWordColorWithString:self.searchSuggestions[indexPath.row] :_searchText :@"" type:self.wolfKill];
//    } else{
//        attriStr = [CWCViewController willChangeWordColorWithString:self.searchSuggestions[indexPath.row] :_searchText :@"" type:@""];
//    }
