...
+ (void)showLoadingHud:(NSString *)textStr inView:(UIView *)view
{
    
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 120, 90)];
    imageView.image = [UIImage animatedImageNamed:@"net-loading-" duration:0.7];
    ...
    hud.bezelView.backgroundColor = view.backgroundColor;
