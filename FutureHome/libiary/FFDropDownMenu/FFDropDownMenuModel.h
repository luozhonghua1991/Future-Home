...
/** 菜单选项消息个数 */
@property (nonatomic, assign) int menuItemMessageNum;
 ...
 *  @return 实例化的菜单模型
 */
+ (instancetype)ff_DropDownMenuModelWithMenuItemTitle:(NSString *)menuItemTitle menuItemIconName:(NSString *)menuItemIconName menuItemMessageNum:(int)menuItemMessageNum menuBlock:(FFMenuBlock)menuBlock;
