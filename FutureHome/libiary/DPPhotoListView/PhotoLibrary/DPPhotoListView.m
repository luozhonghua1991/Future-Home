...
- (instancetype)initWithFrame:(CGRect)frame
            numberOfCellInRow:(NSUInteger)lineNumber
...
- (CGFloat)getItemSizeHeight {
    return _flowLayout.itemSize.height;
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_delegate != nil && [_delegate respondsToSelector:@selector(fh_selectCellWithIndex:)]) {
        [_delegate fh_selectCellWithIndex:indexPath];
    }
//    _isShowingDeleteButton = NO;
