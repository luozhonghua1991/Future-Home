...
@interface FHAddressPickerView : UIView
...
//确定按钮的block
@property (nonatomic, copy) void (^sureBtnBlock)(NSString *province, NSString *city, NSString *district, NSString *addressCode, NSString *parentCode, NSString *provienceCode);
