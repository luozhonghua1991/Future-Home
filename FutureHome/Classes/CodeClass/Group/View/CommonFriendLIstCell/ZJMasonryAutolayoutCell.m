...
- (void)upBtnClick {
    if (_delegate != nil && [_delegate respondsToSelector:@selector(fh_ZJMasonryAutolayoutCellDelegateSelectLikeWithModel:)]) {
        [_delegate fh_ZJMasonryAutolayoutCellDelegateSelectLikeWithModel:self.model];
    }
}
